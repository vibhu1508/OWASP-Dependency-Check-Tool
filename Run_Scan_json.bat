...
.\dc-v12\dependency-check\bin\dependency-check.bat --project "Demo" --scan "presentation_demo" --format JSON --out "./report" --nvdApiKey "%API_KEY%" --noupdate --enableExperimental --disableOssIndex
echo.
echo ==========================================
echo    SCAN COMPLETE! 
